...
import me.amfero.blmclient.util.chestsearchbarutil.ICustomSearchHandler.StringMatcher;
import me.amfero.blmclient.util.chestsearchbarutil.ISearchHandler;
...
public class ChestSearchBar extends Module 
{
	...
	{
		super("ChestSearchBar", "", Category.MISC);
	}
	...
	public static final ResourceLocation GENERAL_ICONS_RESOURCE = new ResourceLocation(Client.MODID, "textures/misc/general_icons.png");
